...
Implements DDoS detection rules based on multiple metric correlations.
"""
...
class ClassificationEngine:
    ...
    def classify(self, anomaly: Dict) -> Dict:
        ...
        if incident_type == "normal" and 'request_rate' in metrics and 'error_rate' in metrics:
            ...
            # Also check absolute error rate from all_metrics
        ...
        if incident_type == "security":
            # Use current error rate to estimate burn
